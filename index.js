...
const btnPlus = document.querySelector('[data-plus-btn]');
console.log(btnPlus);

const  wrapper = document.querySelector('[data-wrapper]');  // document bu body degani bodyning ichidan element olib beradi 
